...
const Footer = () => {
  return (
    <>
    <footer className="bg-gradient-to-b from-[#0F1533] to-[#28166F] dark:bg-gray-900 border-t border-blue-1">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-white font-medium">
                      <li className="mb-4">
                          <a href="#" className="hover:text-yellow-1 duration-400">Contact</a>
                      </li>
                      <li>
                          <a href="#" className="hover:text-yellow-1 duration-400">About US</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-white font-medium">
                      <li className="mb-4">
                          <a href="#" className="hover:text-yellow-1 duration-400">Github</a>
                      </li>
                      <li>
                          <a href="#" className="hover:text-yellow-1 duration-400">Discord</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-white font-medium">
                      <li className="mb-4">
                          <a href="#" className="hover:text-yellow-1 duration-400">Privacy Policy</a>
                      </li>
                      <li>
                          <a href="#" className="hover:text-yellow-1 duration-400">Terms &amp; Conditions</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="#" className="hover:text-yellow-1 duration-500 text-white ms-5">
