...
<div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-2">Make URL Shortener in 4 Easy Steps</h2>
            <p className="text-xl text-gray-700">Follow these simple steps to shorten your URLs quickly and efficiently</p>
          </div>
   <div>
         ...
         <div className="flex-auto border rounded  border-gray-300">
            <div className="flex md:flex-row flex-col items-center">
               <div className="flex-auto">
                  ...
                  <div className="p-3 text-3xl text-gray-800 font">Copy URL</div>
         ...
         <div className="flex-auto border rounded  border-gray-300">
            <div className="flex md:flex-row flex-col items-center">
               <div className="flex-auto">
                  ...
                  <div className="p-3 text-3xl text-gray-800 font">Paste URL Here</div>
                  <div className="px-3 pb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam facilis, voluptates error alias dolorem praesentium sit soluta iure incidunt labore explicabo eaque, quia architecto veritatis dolores, enim consequatur nihil ipsum.</div>
               </div>
         ...
         <div className="flex-auto border rounded  border-gray-300">
            <div className="flex md:flex-row flex-col items-center">
               <div className="flex-auto">
                  ...
                  <div className="p-3 text-3xl text-gray-800 font">Click on Shorten URL Button </div>
                  <div className="px-3 pb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam facilis, voluptates error alias dolorem praesentium sit soluta iure incidunt labore explicabo eaque, quia architecto veritatis dolores, enim consequatur nihil ipsum.</div>
               </div>
         ...
         <div className="flex-auto border rounded  border-gray-300">
            <div className="flex md:flex-row flex-col items-center">
               <div className="flex-auto">
                  ...
                  <div className="p-3 text-3xl text-gray-800 font">Use Generated URL</div>
                  <div className="px-3 pb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam facilis, voluptates error alias dolorem praesentium sit soluta iure incidunt labore explicabo eaque, quia architecto veritatis dolores, enim consequatur nihil ipsum.</div>
               </div>
